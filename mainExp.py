...
if __name__ == "__main__":
    ...
    if alg == "M" or alg == "m" or alg == "1" or alg == "1.":
        ...
        description = "\n \n \n Bubble sort is a simple sorting algorithm. \
                    ...
                    \n \n Read more asortingMethodt (right click): https://www.tutorialspoint.com/data_structures_algorithms/bubble_sort_algorithm.htm"
    elif alg == "All" or alg == "all" or alg == "ALl" or alg == "ALL" or alg == "8" or alg == "8.":
        alg == "8"
        sortingMethod = ["Merge Sort", "Quick Sort", "Insertion Sort", "Selection Sort", "Heap Sort", "Shell Sort", "Bubble Sort"]
        singleSort = mergeSort(unsortedList, 0, N - 1)
    ...
    numOfOper = axis.text(0.02, 0.95, "", transform = axis.transAxes)
    ...
    def addToFigure(unsortedList, singleBar, iters):
        ...
        iters[0] += 1
        numOfOper.set_text("Number of operations: {}".format(iters[0]))
